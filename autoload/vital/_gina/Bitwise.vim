...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gina#Bitwise#import() abort
    return map({'sign_extension': '', '_vital_created': '', 'rshift': '', 'lshift': '', 'compare': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_gina#Bitwise#import() abort', printf("return map({'sign_extension': '', '_vital_created': '', 'rshift': '', 'lshift': '', 'compare': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
" bitwise operators
