...
execute join(['function! vital#_gina#Vim#Buffer#Anchor#import() abort', printf("return map({'focus': '', '_vital_depends': '', 'is_suitable': '', 'focus_if_available': '', '_vital_created': '', 'find_suitable': '', 'get_config': '', 'set_config': '', 'is_available': '', 'attach': '', '_vital_loaded': ''}, \"vital#_gina#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
