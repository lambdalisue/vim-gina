...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gina#Argument#import() abort
  ...
  execute join(['function! vital#_gina#Argument#import() abort', printf("return map({'_vital_depends': '', 'strip_quotes': '', 'parse': '', 'parse_term': '', '_vital_created': '', 'build_pattern': '', 'build_term': '', 'new': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
